...
<a href="{{ site.url }}/images/get.webp" data-lightbox="restful-set" data-title="GET from Server">![GET from Server]({{ site.url }}/images/get.webp)</a>
<a href="{{ site.url }}/images/oauth.webp" data-lightbox="restful-set" data-title="Oauth2">![Oauth2]({{ site.url }}/images/oauth.webp)</a>
<a href="{{ site.url }}/images/test.webp" data-lightbox="restful-set" data-title="Token test">![Token test]({{ site.url }}/images/test.webp)</a>
